...
def layout_(df, fig, fig1, fig10, fig3, fig4, fig72, fig82, fig31, fig32, fig42, fig40, fig50, filter_options):
    ...
    app.layout = html.Div(style={'background': 'url("assets/terrorism-1.png") no-repeat center center fixed', 'backgroundRepeat': 'no-repeat', 'backgroundSize': 'cover', 'width': '100%', 'height': '100%'}, children=[
        ...
        dcc.Tab(label='Infographics tab', id='info_', value='tab-2', style=tab_style, selected_style=tab_selected_style ,children=[
            ...
            dcc.Tabs(id='subtabs', value='subtab', children=[
                ...
                dcc.Tab(label='India Infographics', id='subtab2', value='subtab2', style=tab_style_sub, selected_style=tab_selected_style_sub, children=[
                    ...
                    html.Div(style={'background': 'url("assets/terrorism-1.png") no-repeat center center fixed', 'background-repeat': 'no-repeat', 'backgroundSize': 'cover', 'width': '100%', 'height': '100%'}, children=[

                        #Div that contains different infographics and plot
                        html.Div(id='plots2',style={'width' : '100%', 'display' : 'none'}, children=[

                            
                            #Stacked bar chart displaying year wise attacks for India
                            html.Div(children=[
                                dcc.Graph(id='indbar-1', figure=fig72, style={'width': 1370, 'height': 700, 'marginLeft': '-20px', 'marginBottom' : '-45px'}),
                            ]),
                            ...
                            html.Div(children=[
                            dcc.Graph(id='indbar-2', figure=fig82, style={'width': 1370, 'height': 700, 'marginLeft': '-20px', 'marginBottom' : '-38px'}),
                            ]),
                            ...
                            html.Div(children=[
                                dcc.Graph(id='indpie', figure=fig42, style={'width': 1365, 'height': 600, 'marginLeft': '0px', 'marginBottom' : '0px'}),
                            ]), 


                            #A world map that plays the locations of each attack in India for each year
                            html.Div(children=[
                                dcc.Graph(id='indiageo', figure=fig40, style={'width': 1365, 'height': 600, 'marginLeft': '0px', 'marginBottom' : '0px'}),
                            ]),       
                        ]),    
                    ]),            
                ]),
        ...
        dcc.Tab(label='Explorer tab', id='exp', value='tab-3', style=tab_style, selected_style=tab_selected_style ,children=[
            ...
            html.H1(style={'textAlign': 'center', 'color': '#FFFFFF'}, children='Global Terrorism Database Explorer'),
            html.Div(style={'width': '100%'}, children=[

                html.Div(style={'width': '40%', 'display': 'inline-block', 'textAlign': 'center', 'marginLeft': '450px'}, children=[
                    html.Label('Incidents per Year Grouped by ', style={'color' : '	#FFFFFF', 'fontSize': '30px', 'textAlign': 'center'}),
                    html.Br(),
                    dcc.Dropdown(
                        id='filter',
                ...
                dcc.Graph(id='plots3', figure=fig50, style={'width': 1370, 'height': 600}),
                ...
                html.Div(style={'width': '100%', 'display': 'inline-block', 'align-items': 'center'}, children=[   
                    dcc.RangeSlider(
                        id='yearslider',
                        min=1970,
                        max=2018,
